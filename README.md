This GUI models marketplace functionality. On the starting screen the user has the options of logging in to an exisiting account or creating a new account.
